...
from autils.utils import data_structures


class TestDataStructures(unittest.TestCase):
    """
    Unit tests for autils.utils.data_structures
    """
    ...
    def test_lazy_property_class_access(self):
        ...
        class DummyClass:
            @data_structures.LazyProperty
            def dummy_method(self):  # pylint: disable=no-self-use
                return "test"
    ...
    def test_callback_register_once_flag(self):
        ...
        self.assertEqual(len(register._items), 1)  # pylint: disable=W0212
    ...
    def test_callback_register_unregister_nonexistent(self):
        ...
        self.assertEqual(len(register._items), 0)  # pylint: disable=W0212
...
class TestDataSize(unittest.TestCase):
    def test_valid(self):
        # Test that valid data sizes can be created without exceptions
        self.assertIsInstance(data_structures.DataSize("0"), data_structures.DataSize)
        self.assertIsInstance(data_structures.DataSize("0t"), data_structures.DataSize)
        self.assertIsInstance(data_structures.DataSize("10"), data_structures.DataSize)
