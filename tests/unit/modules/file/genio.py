...
class TestAreFilesEqual(unittest.TestCase):
    ...
    def test_are_files_equal_compares_by_hash(self):
        ...
        file_1 = tempfile.NamedTemporaryFile(mode="w", delete=False)  # pylint: disable=consider-using-with
        file_2 = tempfile.NamedTemporaryFile(mode="w", delete=False)  # pylint: disable=consider-using-with
        # Identical content
